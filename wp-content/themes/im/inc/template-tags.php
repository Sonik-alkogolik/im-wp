...
if ( ! function_exists( 'im_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function im_posted_on() {
...
if ( ! function_exists( 'im_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function im_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'im_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function im_entry_footer() {
...
if ( ! function_exists( 'im_post_thumbnail' ) ) :
	/**
